...
@section('title', 'Promotion Management - Admin Panel')
...
function promotionFormData() {
    return {
        form: {
            ...
            description: '{{ $promotion['description'] ?? 'Get 10% extra diamonds on Mobile Legends!' }}',
            button_text: '{{ $promotion['button_text'] ?? 'Shop Now' }}',
            button_link: '{{ $promotion['button_link'] ?? '/games' }}'
        },
        loading: false,
