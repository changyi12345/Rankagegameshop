    ...
    <div class="card mb-6 bg-gradient-to-br from-dark-card to-dark-base overflow-hidden">
        <div class="flex items-center space-x-4">
            ...
            <div class="flex-1">
                ...
                <p class="text-gray-400 text-sm">{{ $game->currency_name ?? 'Currency' }}</p>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <p class="text-xl font-bold text-secondary">{{ number_format($packagePrice) }}</p>
...
function gameDetailData() {
    return {
        ...
        availableServers: @json($availableServers ?? []),
