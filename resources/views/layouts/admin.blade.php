...
<head>
    ...
    <title>@yield('title', 'Admin Panel - RanKage Game Shop')</title>
        ...
        <aside class="hidden lg:flex lg:flex-shrink-0">
            <div class="w-64 bg-dark-card border-r border-dark-border flex flex-col h-screen">
                ...
                <nav class="flex-1 p-4 space-y-2 overflow-y-auto overflow-x-hidden" style="max-height: calc(100vh - 200px);">
                    ...
                    <a href="/admin/payments" class="nav-item {{ request()->is('admin/payments*') && !request()->is('admin/banks*') && !request()->is('admin/transactions*') ? 'active' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="/admin/banks" class="nav-item {{ request()->is('admin/banks*') ? 'active' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path>
                        </svg>
                        <span>Banks</span>
                    </a>
                    <a href="/admin/api-settings" class="nav-item {{ request()->is('admin/api-settings*') ? 'active' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="/admin/notifications" class="nav-item {{ request()->is('admin/notifications*') ? 'active' : '' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <header class="bg-dark-card border-b border-dark-border px-6 py-4">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <h1 class="text-xl font-bold text-light-text">@yield('page-title', 'Dashboard')</h1>
                    </div>
                    <div class="flex items-center space-x-4">
                        <!-- Notifications -->
