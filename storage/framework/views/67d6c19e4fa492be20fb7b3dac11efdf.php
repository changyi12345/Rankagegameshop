...
<?php $__env->startSection('title', 'Order History - RanKage Game Shop'); ?>
            ...
            <div class="flex items-start justify-between gap-4">
                <div class="flex items-start space-x-4 flex-1 min-w-0">
                    ...
                    <div class="flex-1 min-w-0">
                        <h3 class="font-bold text-light-text mb-1"><?php echo e($order->game->name ?? 'Unknown Game'); ?></h3>
                        <p class="text-xs text-gray-400 mb-1">#<?php echo e($order->order_id); ?></p>
                        <div class="text-sm text-gray-400">
                            <?php if($order->user_game_id): ?>
                                <span><?php echo e($isMLBB ? 'Game ID' : 'User ID'); ?>: </span>
                                <span class="text-light-text font-semibold"><?php echo e($order->user_game_id); ?></span>
                            <?php endif; ?>
                            <?php if($order->server_id): ?>
                                <span class="ml-3"><?php echo e($isMLBB ? 'Zone ID' : 'Server'); ?>: </span>
                ...
                <div class="text-right flex-shrink-0">
                    <p class="text-xl font-bold text-secondary mb-2"><?php echo e(number_format($order->amount)); ?> K</p>
                    <div class="mb-2">
                    ...
                    <p class="text-xs text-gray-400"><?php echo e($order->created_at->format('M d, Y')); ?></p>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\RanKeagegmshop\resources\views/user/orders/index.blade.php ENDPATH**/ ?>