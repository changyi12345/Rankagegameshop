...
<?php $__env->startSection('title', 'Logo Management - Admin Panel'); ?>
<?php $__env->startSection('page-title', 'Logo Management'); ?>
                        ...
                        <div class="flex items-center space-x-6">
                            ...
                            <div class="flex-1">
                                ...
                                <label for="logo-upload" 
                                    ...
                                    <?php echo e($logo ? 'Change Logo' : 'Upload Logo'); ?>
...
function logoFormData() {
    return {
        form: {
            ...
            logoPreview: null,
            removeLogo: false,
            siteName: '<?php echo e($siteName ?? 'RanKage'); ?>',
            siteTagline: '<?php echo e($siteTagline ?? 'Game Shop'); ?>'
        },
        currentLogo: <?php if($logo): ?> '<?php echo e(asset('storage/' . $logo)); ?>' <?php else: ?> null <?php endif; ?>,
        loading: false,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\RanKeagegmshop\resources\views/admin/logo/index.blade.php ENDPATH**/ ?>