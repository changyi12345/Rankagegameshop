...
<?php $__env->startSection('title', 'Notifications - Admin Panel'); ?>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" 
                               ...
                               value="<?php echo e($bot_settings->token ?? ''); ?>">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               value="<?php echo e($bot_settings->admin_chat_id ?? ''); ?>">
            ...
            <div class="space-y-3 max-h-96 overflow-y-auto">
                ...
                <div class="bg-dark-base rounded-xl p-4">
                    <div class="flex items-start justify-between mb-2">
                        <div>
                            <p class="text-light-text font-semibold"><?php echo e($notification->type ?? 'Notification'); ?></p>
                            <p class="text-gray-400 text-sm"><?php echo e($notification->message ?? 'No message'); ?></p>
                        </div>
                        <span class="text-gray-500 text-xs"><?php echo e($notification->created_at->format('M d, h:i A')); ?></span>
                    </div>
...
function notificationsData() {
    return {
        botForm: {
            token: '<?php echo e($bot_settings->token ?? ''); ?>',
            admin_chat_id: '<?php echo e($bot_settings->admin_chat_id ?? ''); ?>',
            notify_new_order: <?php echo e($bot_settings->notify_new_order ?? true ? 'true' : 'false'); ?>,
            notify_payment_pending: <?php echo e($bot_settings->notify_payment_pending ?? true ? 'true' : 'false'); ?>,
            notify_low_balance: <?php echo e($bot_settings->notify_low_balance ?? true ? 'true' : 'false'); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\RanKeagegmshop\resources\views/admin/notifications/index.blade.php ENDPATH**/ ?>