...
<?php $__env->startSection('title', 'Home - RanKage Game Shop'); ?>
...
<div class="container mx-auto px-4 py-4">
    ...
    <div class="card mb-6 bg-gradient-to-r from-dark-card to-dark-base">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-secondary"><?php echo e(number_format(auth()->user()->balance ?? 0)); ?> <span class="text-lg text-gray-400">Ks</span></p>
            </div>
    ...
    <div class="mb-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="text-primary text-sm font-semibold">View All</a>
        </div>
        <div class="card bg-gradient-to-r from-dark-card via-dark-base to-dark-card">
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="btn-primary w-full py-3 text-center block">
                Browse Products
            </a>
        </div>
    </div>
    ...
    <div class="mb-6">
        ...
        <div class="space-y-3">
            <?php $__empty_1 = true; $__currentLoopData = auth()->user()->orders()->latest()->take(3)->get() ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <a href="/orders/<?php echo e($order->id); ?>" class="card hover:bg-dark-base transition-colors block">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <div class="flex items-center space-x-3 mb-2">
                            <span class="text-2xl"><?php echo e($order->game->icon ?? '🎮'); ?></span>
                            <div>
                                <h3 class="font-bold text-light-text"><?php echo e($order->game->name ?? 'Unknown Game'); ?></h3>
                                <p class="text-xs text-gray-400">Order #<?php echo e($order->order_id); ?></p>
                            </div>
                        </div>
                        <div class="flex items-center space-x-4 text-sm">
                            <span class="text-gray-400"><?php echo e(number_format($order->amount)); ?> Ks</span>
                            <span class="text-gray-500">•</span>
                            <span class="text-gray-400"><?php echo e($order->created_at->diffForHumans()); ?></span>
                        </div>
                    </div>
                    <div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\RanKeagegmshop\resources\views/user/home.blade.php ENDPATH**/ ?>