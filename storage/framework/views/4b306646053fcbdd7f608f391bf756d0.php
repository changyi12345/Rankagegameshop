...
<?php $__env->startSection('title', 'Edit Game - Admin Panel'); ?>
<?php $__env->startSection('page-title', 'Edit Game'); ?>
                ...
                <div class="space-y-4">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <label for="image-upload-edit" 
                                    ...
                                    <?php echo e($game->image ? 'Change Image' : 'Choose Image'); ?>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               required 
                               class="input-field" 
                               value="<?php echo e($game->currency_name ?? ''); ?>">
                    </div>
                    ...
                    <div>
                        ...
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" 
                                   ...
                                   <?php echo e(($game->requires_server ?? false) ? 'checked' : ''); ?>
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               step="0.1"
                               class="input-field" 
                               value="<?php echo e($game->profit_margin ?? 10); ?>">
                    ...
                    <div>
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" 
                                   ...
                                   <?php echo e(($game->is_active ?? true) ? 'checked' : ''); ?>
...
function gameFormData() {
    return {
        form: {
            ...
            icon: '<?php echo e($game->icon ?? ''); ?>',
            image: null,
            imagePreview: null,
            currency_name: '<?php echo e($game->currency_name ?? ''); ?>',
            requires_server: <?php echo e(($game->requires_server ?? false) ? 'true' : 'false'); ?>,
            profit_margin: <?php echo e($game->profit_margin ?? 10); ?>,
            is_active: <?php echo e(($game->is_active ?? true) ? 'true' : 'false'); ?>
        ...
        async submitForm() {
            ...
            try {
                ...
                const res = await fetch('/admin/games/<?php echo e($game->id ?? 0); ?>', {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\RanKeagegmshop\resources\views/admin/games/edit.blade.php ENDPATH**/ ?>