...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'RanKage Game Shop'); ?></title>
    ...
    <div class="min-h-screen pb-20">
                    ...
                    <div class="flex items-center space-x-3">
                        <?php if(auth()->guard()->check()): ?>
                            ...
                            <div class="hidden sm:flex items-center space-x-2 bg-dark-base px-3 py-1.5 rounded-lg">
                                ...
                                <span class="text-sm font-bold text-secondary"><?php echo e(number_format(auth()->user()->balance ?? 0)); ?> Ks</span>
                            </div>
        ...
        <nav class="fixed bottom-0 left-0 right-0 bg-dark-card border-t border-dark-border z-50 sm:hidden">
            <div class="flex items-center justify-around py-2">
                <a href="/" class="flex flex-col items-center space-y-1 px-4 py-2 <?php echo e(request()->is('/') ? 'text-primary' : 'text-gray-400'); ?>">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                    </svg>
                    <span class="text-xs">Home</span>
                </a>
                <a href="/orders" class="flex flex-col items-center space-y-1 px-4 py-2 <?php echo e(request()->is('orders*') ? 'text-primary' : 'text-gray-400'); ?>">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                    </svg>
                    <span class="text-xs">Orders</span>
                </a>
                <a href="/wallet" class="flex flex-col items-center space-y-1 px-4 py-2 <?php echo e(request()->is('wallet*') && !request()->is('transactions*') ? 'text-primary' : 'text-gray-400'); ?>">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php if(auth()->guard()->check()): ?>
                <a href="/transactions" class="flex flex-col items-center space-y-1 px-4 py-2 <?php echo e(request()->is('transactions*') ? 'text-primary' : 'text-gray-400'); ?>">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                    </svg>
                    <span class="text-xs">Transactions</span>
                </a>
                <a href="/profile" class="flex flex-col items-center space-y-1 px-4 py-2 <?php echo e(request()->is('profile*') ? 'text-primary' : 'text-gray-400'); ?>">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                    </svg>
                ...
                <?php else: ?>
                <a href="/login" class="flex flex-col items-center space-y-1 px-4 py-2 <?php echo e(request()->is('login*') ? 'text-primary' : 'text-gray-400'); ?>">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                    </svg>
...
<?php /**PATH C:\Users\Lenovo\Desktop\RanKeagegmshop\resources\views/layouts/user.blade.php ENDPATH**/ ?>