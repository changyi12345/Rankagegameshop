...
<?php $__env->startSection('title', 'Profile - RanKage Game Shop'); ?>
    ...
    <div x-data="profileData()">
        ...
        <div class="card mb-6">
            <div class="flex items-center space-x-4 mb-6">
                ...
                <div class="flex-1">
                    <h2 class="text-xl font-bold text-light-text"><?php echo e(auth()->user()->name ?? 'User'); ?></h2>
                    <p class="text-gray-400 text-sm"><?php echo e(auth()->user()->phone ?? 'No phone'); ?></p>
                    <?php if(auth()->user()->telegram_id): ?>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\RanKeagegmshop\resources\views/user/profile.blade.php ENDPATH**/ ?>