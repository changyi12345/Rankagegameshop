        ...
        <div class="card bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-light-text"><?php echo e(number_format($stats['today_orders'] ?? 0)); ?></p>
                </div>
        ...
        <div class="card bg-gradient-to-br from-secondary/10 to-secondary/5 border-secondary/20">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-secondary"><?php echo e(number_format($stats['total_revenue'] ?? 0)); ?> <span class="text-lg text-gray-400">Ks</span></p>
                </div>
        ...
        <div class="card bg-gradient-to-br from-yellow-500/10 to-yellow-500/5 border-yellow-500/20">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-yellow-400"><?php echo e(number_format($stats['pending_orders'] ?? 0)); ?></p>
                </div>
        ...
        <div class="card bg-gradient-to-br from-blue-500/10 to-blue-500/5 border-blue-500/20">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-blue-400"><?php echo e(number_format($stats['g2bulk_balance'] ?? 0)); ?> <span class="text-lg text-gray-400">USD</span></p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-dark-border hover:bg-dark-base transition-colors">
                            ...
                            <td class="py-3 px-4 text-gray-400 text-sm"><?php echo e($order->created_at->format('M d, h:i A')); ?></td>
                        </tr>
        ...
        <div class="space-y-6">
            ...
            <div class="card">
                ...
                <div class="space-y-3">
                    <a href="<?php echo e(route('admin.games.create')); ?>" class="flex items-center justify-center space-x-2 btn-primary w-full py-3">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
                        <span>Add New Game</span>
                    </a>
                    <a href="<?php echo e(route('admin.orders.index', ['status' => 'pending'])); ?>" class="flex items-center justify-center space-x-2 btn-outline w-full py-3">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path>
                        </svg>
                        <span>View Pending Orders</span>
                    </a>
                    <a href="<?php echo e(route('admin.api-settings.index')); ?>" class="flex items-center justify-center space-x-2 btn-outline w-full py-3">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="<?php echo e(route('admin.payments.index')); ?>" class="flex items-center justify-center space-x-2 btn-outline w-full py-3">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"></path>
                        </svg>
            ...
            <div class="card">
                ...
                <div class="text-center">
                    ...
                    <p class="text-4xl font-bold text-primary mb-2"><?php echo e(number_format($stats['user_count'] ?? 0)); ?></p>
                    <p class="text-gray-400 text-sm mb-4">Total Users</p>
                    <a href="<?php echo e(route('admin.users.index')); ?>" class="btn-outline w-full py-2 text-center text-sm">View All Users</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\RanKeagegmshop\resources\views/admin/dashboard/index.blade.php ENDPATH**/ ?>