...
<div class="container mx-auto px-4 py-4">
    ...
    <div class="card mb-6 bg-gradient-to-br from-dark-card to-dark-base overflow-hidden">
        <div class="flex items-center space-x-4">
            ...
            <div class="flex-1">
                ...
                <p class="text-gray-300 text-sm"><?php echo e($game->currency_name ?? 'Currency'); ?></p>
    ...
    <script>
    window.gamePageConfig = JSON.parse(atob('<?php echo e(base64_encode(json_encode($jsConfig))); ?>'));
</script>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <p class="text-xl font-bold text-secondary"><?php echo e(number_format($packagePrice, 0)); ?></p>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\RanKeagegmshop\resources\views/user/games/show.blade.php ENDPATH**/ ?>