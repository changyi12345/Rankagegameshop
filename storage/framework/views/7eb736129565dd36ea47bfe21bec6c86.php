...
<?php $__env->startSection('title', 'Bank Management - Admin Panel'); ?>
...
<div class="space-y-6">
    ...
    <div class="card">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <?php $__empty_1 = true; $__currentLoopData = \App\Models\Bank::active()->ordered()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-dark-base rounded-xl p-4 border border-dark-border">
                <div class="flex items-center justify-between mb-3">
                    <h3 class="font-bold text-light-text"><?php echo e($bank->bank_name); ?></h3>
                ...
                <div class="space-y-2 text-sm">
                    <div>
                        ...
                        <p class="text-light-text font-semibold"><?php echo e($bank->account_name); ?></p>
                    </div>
                    <div>
                        <p class="text-gray-400">Account Number</p>
                        <p class="text-light-text font-semibold font-mono"><?php echo e($bank->account_number); ?></p>
                    </div>
                    <?php if($bank->qr_code): ?>
                    <div>
                        <p class="text-gray-400 mb-2">QR Code</p>
                        <img src="<?php echo e(asset('storage/' . $bank->qr_code)); ?>" alt="QR Code" class="w-32 h-32 object-contain bg-white rounded-lg">
                    </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-dark-border hover:bg-dark-base transition-colors">
                        <td class="p-4 text-light-text font-semibold"><?php echo e($bank->bank_name); ?></td>
                        <td class="p-4 text-light-text"><?php echo e($bank->account_name); ?></td>
                        <td class="p-4 text-light-text font-mono"><?php echo e($bank->account_number); ?></td>
                        <td class="p-4">
                            <?php if($bank->qr_code): ?>
                                <img src="<?php echo e(asset('storage/' . $bank->qr_code)); ?>" alt="QR Code" class="w-16 h-16 object-contain bg-white rounded">
                            <?php else: ?>
                                <span class="text-gray-500">-</span>
                            <?php endif; ?>
                        </td>
                        <td class="p-4 text-light-text"><?php echo e($bank->sort_order); ?></td>
                        <td class="p-4">
                            <?php if($bank->is_active): ?>
                                <span class="badge badge-success">Active</span>
                            <?php else: ?>
                        ...
                        <td class="p-4">
                            <div class="flex items-center justify-end space-x-2">
                                <button onclick="toggleBank(<?php echo e($bank->id); ?>)" class="text-primary hover:text-primary-light text-sm">
                                    <?php echo e($bank->is_active ? 'Disable' : 'Enable'); ?>

                                </button>
                                <button onclick="openEditModal(<?php echo e($bank->id); ?>)" class="text-secondary hover:text-secondary-light text-sm">Edit</button>
                                <button onclick="deleteBank(<?php echo e($bank->id); ?>)" class="text-red-400 hover:text-red-300 text-sm">Delete</button>
                            </div>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lenovo\Desktop\RanKeagegmshop\resources\views/admin/banks/index.blade.php ENDPATH**/ ?>